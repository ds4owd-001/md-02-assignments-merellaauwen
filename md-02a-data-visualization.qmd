...
#data types --> continent = categorical, life expectancy = numerical, fill = categorical
```
...
#bar charts automatically use the count, which is what we specified the column chart in the previous exercise to do
```
